...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FC]">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 bg-white/15 backdrop-blur-md rounded-full px-2.5 py-1.5 active:scale-95 transition-transform"
              >
      ...
      {/* ═══════════════════ PET CARD ═══════════════════ */}
      <motion.div custom={4} variants={fadeUp} initial="hidden" animate="visible" className="mx-auto max-w-md px-4 pb-24">
        {!petType ? (
          <button
